...
create or replace procedure dev.new_proc(salary in number, percent in number) as
begin
...
(
    ...
    CONSTRAINT fk_ex FOREIGN KEY (ex_id) REFERENCES dev.cycle (ex_id)
);
/

drop table dev.cycle;
...
--
--create or replace NONEDITIONABLE PROCEDURE dev.i_pass AS
--BEGIN
--    dbms_output.put_line('I pass!');
--END;
--
--
--drop procedure dev.i_dont_pass;
--
--

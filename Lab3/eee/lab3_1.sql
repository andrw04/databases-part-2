...
create or replace procedure prod.new_proc(salary in number, percent in number) as
begin
    dbms_output.put_line('Goodbie!');
end;
...
--create or replace NONEDITIONABLE PROCEDURE prod.i_pass AS
--BEGIN
--    dbms_output.put_line('I dont pass!');
--END;
